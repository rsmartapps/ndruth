      ...
      <div class="container-fluid">
        ...
        <div class="navbar-dark row text-center">
          <div class="col-lg-4 ml-auto">
            ...
            <a class="nav-link p-0" href="<?php esc_url('mailto:contact@ndruthsebastian.com'.antispambot('contact@ndruthsebastian.com')); ?>"><?php esc_html('Contact'.antispambot('contact@ndruthsebastian.com'));?></a>
            </p>
